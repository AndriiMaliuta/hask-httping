...
/* package postgresql-simple-url-0.2.1.0 */
#ifndef VERSION_postgresql_simple_url
#define VERSION_postgresql_simple_url "0.2.1.0"
#endif /* VERSION_postgresql_simple_url */
#ifndef MIN_VERSION_postgresql_simple_url
#define MIN_VERSION_postgresql_simple_url(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 1)
#endif /* MIN_VERSION_postgresql_simple_url */
